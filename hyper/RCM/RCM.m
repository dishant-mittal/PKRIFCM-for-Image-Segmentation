...
for index=(C+1):datapoints
    ...
    if (distance(index,max2)-distance(index,max1))<=0.00000000001
        flag=1;
        ...
        while(c_approx(2,max1,count2)~=-1 && count2<=datapoints)   
            sum2=sum2+double(Im(c_approx(2,max1,count2),:));
            count2=count2+1;
        end
        ...
        while(c_approx(2,max2,count2)~=-1 && count2<=datapoints)   
            sum2=sum2+double(Im(c_approx(2,max2,count2),:));
            count2=count2+1;
        end
...
for i=1:C
    ...
    while(c_approx(2,i,count2)~=-1 && count2<=datapoints)   
        sum2=sum2+double((distance(c_approx(2,i,count2),i))^2);
        count2=count2+1;
    end
